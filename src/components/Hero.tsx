        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6 enter">
            ...
            <p className="text-lg text-muted-foreground max-w-xl">
              Transform your underwriting department with AI-driven insights. Built for Aguila Dorada, a team who demand precision, transparency, and speed.
            </p>
            <div className="flex flex-wrap gap-3">
              {/* Replaced "Test the Agent" button with floating VAPI widget launcher */}
              <vapi-widget
                public-key="aff5e99d-8932-496d-a975-1a8925b60c8b"
                assistant-id="0686a71b-f6c9-4168-b472-95ffd0f2c32c"
                mode="voice"
                theme="dark"
                position="bottom-right"
                size="compact"
                title="TALK WITH UNDERWRITING"
          ...
          <div className="relative animate-slide-in-right">
            ...
            <div className="glass-panel rounded-2xl overflow-hidden border relative">
              <img
                src={heroImage}
                alt="Abstract data waves morphing into a structured grid in electric blue and teal"
