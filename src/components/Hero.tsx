      ...
      <div className="container mx-auto px-6 pt-24 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6 enter">
            ...
            <p className="text-lg text-muted-foreground max-w-xl">Transform your underwriting department with AI-driven insights. Built for Aguila Dorada, a team who demand precision, transparency, and speed.</p>
